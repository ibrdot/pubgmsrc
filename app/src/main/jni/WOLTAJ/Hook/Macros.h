...
#include "WOLTAJ/Substrate/And64InlineHook.hpp"

#else //Compile for armv7 lib only. Do not worry about greyed out highlighting code, it still works
#include "WOLTAJ/Substrate/SubstrateHook.h"
#include "WOLTAJ/Substrate/CydiaSubstrate.h"
...
#define HOOOK_LIB(lib, offset, ptr, orig) hook((void *)getAbsoluteAddress(OBFUSCATE(lib), string2Offset(OBFUSCATE(offset))), (void *)ptr, (void **)&orig)
