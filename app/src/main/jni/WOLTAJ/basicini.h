...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
SI_Error
CSimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::LoadData(const char * a_pData, size_t a_uDataLen)
{
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
SI_Error
CSimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::LoadData(std::istream & a_istream)
{
    std::string strData;
    char szBuf[512];
    do {
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
bool
CSimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::FindEntry(SI_CHAR *& a_pData, const SI_CHAR *& a_pSection, const SI_CHAR *& a_pKey, const SI_CHAR *& a_pVal, const SI_CHAR *& a_pComment) const
{
    a_pComment = NULL;
    ...
    while (*a_pData) {
        ...
        *pTrail = 0;
        ...
        pTrail = a_pData - 1;
        if (*a_pData) SkipNewLine(a_pData);
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
bool
CSimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::LoadMultiLineText(SI_CHAR *& a_pData, const SI_CHAR *& a_pVal, const SI_CHAR * a_pTagName, bool a_bAllowBlankLinesInComment) const
{
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
SI_Error
CSimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::AddEntry(const SI_CHAR * a_pSection, const SI_CHAR * a_pKey, const SI_CHAR * a_pValue, const SI_CHAR * a_pComment, bool a_bForceReplace, bool a_bCopyStrings)
{
    SI_Error rc;
    ...
    if (!a_pKey || !a_pValue) return bInserted ? SI_INSERTED : SI_UPDATED;
    ...
    if (iKey == keyval.end() || bForceCreateNewKey) {
        ...
        if (a_pComment) oKey.pComment = a_pComment;
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
const SI_CHAR *
CSimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::GetValue(const SI_CHAR * a_pSection, const SI_CHAR * a_pKey, const SI_CHAR * a_pDefault, bool * a_pHasMultiple) const
{
    ...
    if (m_bAllowMultiKey && a_pHasMultiple) {
        ...
        if (++iTemp != iSection->second.end()) {
            if (!IsLess(a_pKey, iTemp->first.pItem)) *a_pHasMultiple = true;
        }
    }
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
long
CSimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::GetLongValue(const SI_CHAR * a_pSection, const SI_CHAR * a_pKey, long a_nDefault, bool * a_pHasMultiple) const
{
    ...
    else nValue = strtol(szValue, &pszSuffix, 10);
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
SI_Error 
CSimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::SetLongValue(const SI_CHAR * a_pSection, const SI_CHAR * a_pKey, long a_nValue, const SI_CHAR * a_pComment, bool a_bUseHex, bool a_bForceReplace)
{
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
double
CSimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::GetDoubleValue(const SI_CHAR * a_pSection, const SI_CHAR * a_pKey, double a_nDefault, bool * a_pHasMultiple) const
{
    const SI_CHAR * pszValue = GetValue(a_pSection, a_pKey, NULL, a_pHasMultiple);
    if (!pszValue || !*pszValue) return a_nDefault;
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
SI_Error 
CSimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::SetDoubleValue(const SI_CHAR * a_pSection, const SI_CHAR * a_pKey, double a_nValue, const SI_CHAR * a_pComment, bool a_bForceReplace)
{
	if (!a_pSection || !a_pKey) return SI_FAIL;
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
bool
CSimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::GetBoolValue(const SI_CHAR * a_pSection, const SI_CHAR * a_pKey, bool a_bDefault, bool * a_pHasMultiple) const
{
    const SI_CHAR * pszValue = GetValue(a_pSection, a_pKey, NULL, a_pHasMultiple);
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
SI_Error 
CSimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::SetBoolValue(const SI_CHAR * a_pSection, const SI_CHAR * a_pKey, bool a_bValue, const SI_CHAR * a_pComment, bool a_bForceReplace)
{
    if (!a_pSection || !a_pKey) return SI_FAIL;
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
bool
CSimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::GetAllValues(const SI_CHAR * a_pSection, const SI_CHAR * a_pKey, TNamesDepend & a_values) const
{
    a_values.clear();
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
SI_Error
CSimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::SaveFile(const char * a_pszFile, bool a_bAddSignature) const
{
    FILE * fp = NULL;
#if __STDC_WANT_SECURE_LIB__ && !_WIN32_WCE
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
SI_Error
CSimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::SaveFile(const SI_WCHAR_T * a_pwszFile, bool a_bAddSignature) const
{
#ifdef _WIN32
    FILE * fp = NULL;
#if __STDC_WANT_SECURE_LIB__ && !_WIN32_WCE
...
CSimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::Save(OutputWriter & a_oOutput, bool a_bAddSignature) const
{
    ...
    for ( ; iSection != oSections.end(); ++iSection ) {
        if (iSection->pComment) {
            ...
            if (!OutputMultiLineText(a_oOutput, convert, iSection->pComment)) return SI_FAIL;
            bNeedNewLine = false;
        }
        ...
        if (*iSection->pItem) {
            if (!convert.ConvertToStore(iSection->pItem)) return SI_FAIL;
            a_oOutput.Write("[");
        ...
        for ( ; iKey != oKeys.end(); ++iKey) {
            ...
            for ( ; iValue != oValues.end(); ++iValue) {
                if (iValue->pComment) {
                    a_oOutput.Write(SI_NEWLINE_A);
                    if (!OutputMultiLineText(a_oOutput, convert, iValue->pComment)) return SI_FAIL;
                }

                if (!convert.ConvertToStore(iKey->pItem)) return SI_FAIL;
                a_oOutput.Write(convert.Data());

                if (!convert.ConvertToStore(iValue->pItem)) return SI_FAIL;
                a_oOutput.Write(m_bSpaces ? " = " : "=");
                if (m_bAllowMultiLine && IsMultiLineData(iValue->pItem)) {
                    a_oOutput.Write("<<<END_OF_TEXT" SI_NEWLINE_A);
                    if (!OutputMultiLineText(a_oOutput, convert, iValue->pItem)) return SI_FAIL;
                    a_oOutput.Write("END_OF_TEXT");
                }
                else a_oOutput.Write(convert.Data());
                a_oOutput.Write(SI_NEWLINE_A);
            }
        }
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
bool
CSimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::OutputMultiLineText(OutputWriter & a_oOutput, Converter & a_oConverter, const SI_CHAR * a_pText) const
{
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
bool
CSimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::DeleteValue(const SI_CHAR * a_pSection, const SI_CHAR * a_pKey, const SI_CHAR * a_pValue, bool a_bRemoveEmpty)
{
    if (!a_pSection) return false;
    ...
    if (a_pKey) {
        ...
        do {
            ...
            if(a_pValue == NULL || (isLess(a_pValue, iDelete->second) == false && isLess(iDelete->second, a_pValue) == false)) {
