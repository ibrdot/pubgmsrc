...
{
public:
	struct FDestructibleParameters                     DefaultDestructibleParameters;                            // 0x0458(0x0088) (Edit)
	TArray<struct FFractureEffect>                     FractureEffects;                                          // 0x04E0(0x0010) (Edit, EditFixedSize, ZeroConstructor)
