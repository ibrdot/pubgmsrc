...
public:
	...
	bool                                               bIsDestructibleItem;                                      // 0x02DC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseMeshMapping;                                          // 0x02DD(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x7A];                                      // 0x02DE(0x007A) MISSED OFFSET
	...
	class UDamageableComponentBase*                    CachedDamageableComp;                                     // 0x0360(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class ASTExtraBaseCharacter*                       CachedCharacterOwner;                                     // 0x0368(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x8];                                       // 0x0370(0x0008) MISSED OFFSET
...
// Class AI.BTService_ChooseMonsterEnemy
// 0x0038 (0x00A0 - 0x0068)
class UBTService_ChooseMonsterEnemy : public UBTService
{
public:
	struct FBlackboardKeySelector                      BBKeyMonsterTarget;                                       // 0x0068(0x0028) (Edit, BlueprintVisible)
	TArray<int>                                        SupportedMonsterIDs;                                      // 0x0090(0x0010) (Edit, BlueprintVisible, ZeroConstructor)

	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class AI.BTService_ChooseMonsterEnemy");
		return pStaticClass;
	}
...
public:
	...
	struct FBlackboardKeySelector                      LastWayPointActor;                                        // 0x00A0(0x0028) (Edit)
	bool                                               ReachedEndNoNextWayPointRetFalse;                         // 0x00C8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bFindNextInRange;                                         // 0x00C9(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bSendEvent;                                               // 0x00CA(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	bool                                               bFailWhenCastFailed;                                      // 0x0074(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0075(0x0003) MISSED OFFSET
...
public:
	...
	bool                                               bEnableDebugLog;                                          // 0x00CD(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
// 0x0020 (0x7410 - 0x73F0)
class AMercenaryAICharacterBase : public ASTExtraPlayerCharacter
{
public:
	bool                                               bShouldUseGameModeNetCullingDist;                         // 0x73F0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x73F1(0x0003) MISSED OFFSET
	float                                              AttachedActorFoldWeaponMaxAngle;                          // 0x73F4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              AttachedPlayerHeightOffset;                               // 0x73F8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     GrenadeThrowOffset;                                       // 0x73FC(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x7408(0x0008) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData10[0x464];                                     // 0x03E4(0x0464) MISSED OFFSET
...
public:
	...
	int                                                nModGameType;                                             // 0x07C0(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                OverrideMapID;                                            // 0x07C4(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x50];                                      // 0x07C8(0x0050) UNKNOWN PROPERTY: SetProperty AI.MLAISubSystem.TeammateMLAITeamIDSet
	...
	unsigned char                                      UnknownData07[0x7];                                       // 0x0829(0x0007) MISSED OFFSET
	...
	unsigned char                                      UnknownData08[0x3];                                       // 0x0891(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData09[0x50];                                      // 0x08A0(0x0050) UNKNOWN PROPERTY: SetProperty AI.MLAISubSystem.AICheckVisibilityFilteredActors
	...
	unsigned char                                      UnknownData10[0x58];                                      // 0x0910(0x0058) MISSED OFFSET
	...
	TArray<class ASpecialZoneActor*>                   PendingUpdateSpecialZones;                                // 0x09C8(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData11[0x18];                                      // 0x09D8(0x0018) MISSED OFFSET
	class ABattleRoyaleGameMode*                       CurGameMode;                                              // 0x09F0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x8];                                       // 0x09F8(0x0008) MISSED OFFSET
	class UDataTableProxy*                             ItemTable;                                                // 0x0A00(0x0008) (ZeroConstructor, IsPlainOldData)
	...
	void AddPendingUpdateSpecialZone(class ASpecialZoneActor* InSpecialZone);
...
class ASpecialZoneActor : public ALuaActor
{
public:
	float                                              Radius;                                                   // 0x0570(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                Type;                                                     // 0x0574(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsDynamic;                                                // 0x0578(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0579(0x0003) MISSED OFFSET
	int                                                CustomState;                                              // 0x057C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TMap<uint32_t, float>                              CustomAttributeMap;                                       // 0x0580(0x0050) (ZeroConstructor)
	bool                                               IsDestructibleMesh;                                       // 0x05D0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsInstanced;                                              // 0x05D1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x05D2(0x0002) MISSED OFFSET
	int                                                InstancedMaxNum;                                          // 0x05D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TMap<struct FString, int>                          StaticMeshNameToType;                                     // 0x05D8(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               CheckNearHaveAI;                                          // 0x0628(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0629(0x0003) MISSED OFFSET
	float                                              CheckAIDist;                                              // 0x062C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USpecialZoneShapeComponent*                  SpecialZoneShapeComponent;                                // 0x0630(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class AActor*                                      CacheParentActor;                                         // 0x0638(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0640(0x0004) MISSED OFFSET
	uint32_t                                           ExtraState;                                               // 0x0644(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              Health;                                                   // 0x0648(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsSpawnBTAINeedCheck;                                     // 0x064C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	ESpecialZoneType                                   SpecialZoneType;                                          // 0x064D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0xA];                                       // 0x064E(0x000A) MISSED OFFSET
	class AAIWorldVolume*                              AIWorldVolume;                                            // 0x0658(0x0008) (ZeroConstructor, IsPlainOldData)
	class UInstancedStaticMeshComponent*               CacheInstancedMeshComp;                                   // 0x0660(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class USTDestructionComponent*                     CacheDestructibleMeshComp;                                // 0x0668(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
public:
	...
	bool                                               bOnlyOnLandscape;                                         // 0x0130(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x7];                                       // 0x0131(0x0007) MISSED OFFSET
	struct FName                                       LandscapeTag;                                             // 0x0138(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FGameModeAIPlayerParams                     AIParams;                                                 // 0x0248(0x0408)
	uint32_t                                           AILevel;                                                  // 0x0650(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           MLAIStyle;                                                // 0x0654(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           TargetPlayerKey;                                          // 0x0658(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x065C(0x0004) MISSED OFFSET
	class ASTExtraPlayerController*                    OwnerPlayerController;                                    // 0x0660(0x0008) (ZeroConstructor, IsPlainOldData)
	float                                              DefaultExitTime;                                          // 0x0668(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x066C(0x0004) MISSED OFFSET
	struct FTimerHandle                                TeammateMLAIExitTimer;                                    // 0x0670(0x0008)
	bool                                               bIsTakeOverTeammate;                                      // 0x0678(0x0001) (ZeroConstructor, IsPlainOldData)
