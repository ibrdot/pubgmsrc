...
struct FBaseModAIPlayerState : public FAIStateInfoBase
{
	...
	TArray<uint64_t>                                   pawn_state_list;                                          // 0x00D0(0x0010) (ZeroConstructor)
	bool                                               is_lost_connection;                                       // 0x00E0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x00E1(0x0003) MISSED OFFSET
	int                                                ai_kill_count;                                            // 0x00E4(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               in_delivery_pool;                                         // 0x00E8(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               has_gone;                                                 // 0x00E9(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               in_afk;                                                   // 0x00EA(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x1];                                       // 0x00EB(0x0001) MISSED OFFSET
	int                                                emote_id;                                                 // 0x00EC(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               is_move_has_collision;                                    // 0x00F0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x3];                                       // 0x00F1(0x0003) MISSED OFFSET
	...
	float                                              realscore_mu;                                             // 0x00FC(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              realscore_sigma;                                          // 0x0100(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                zone_id;                                                  // 0x0104(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                Gender;                                                   // 0x0108(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x4];                                       // 0x010C(0x0004) MISSED OFFSET
	struct FString                                     OpenID;                                                   // 0x0110(0x0010) (ZeroConstructor)
	int                                                high_hp_destroy_bullet_num;                               // 0x0120(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                low_hp_destroy_bullet_num;                                // 0x0124(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                fatal_damage_destroy_bullet_num;                          // 0x0128(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               is_weapon_near_wall;                                      // 0x012C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x3];                                       // 0x012D(0x0003) MISSED OFFSET
	struct FAIStateXYZ                                 head_position;                                            // 0x0130(0x000C)
	struct FAIStateXYZ                                 muzzle_position;                                          // 0x013C(0x000C)
	uint32_t                                           ally_master_id;                                           // 0x0148(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                first_lang_id;                                            // 0x014C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                received_fatal_destroy_bullet_num;                        // 0x0150(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData11[0x4];                                       // 0x0154(0x0004) MISSED OFFSET
};
...
{
	struct FBaseModAIPlayerState                       State;                                                    // 0x0020(0x0158)
	struct FAIPlayerInteractInfo                       player_interact_info;                                     // 0x0178(0x0058)
	struct FCameraState                                Camera;                                                   // 0x01D0(0x0040)
	struct FAIPlayerWeapon                             Weapon;                                                   // 0x0210(0x0028)
	struct FAIPlayerBackpack                           BackPack;                                                 // 0x0238(0x0028)
	struct FAIPlayerEquipment                          equipment;                                                // 0x0260(0x0028)
	uint32_t                                           Key;                                                      // 0x0288(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           ai_style;                                                 // 0x028C(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FChatMsgInfo>                        chatmsg_info_list;                                        // 0x0290(0x0010) (ZeroConstructor)
	TArray<struct FSignMsgInfo>                        signmsg_info_list;                                        // 0x02A0(0x0010) (ZeroConstructor)
	TArray<struct FMapMarkInfo>                        mapmark_info_list;                                        // 0x02B0(0x0010) (ZeroConstructor)
	TArray<struct FAIAvatarInfo>                       avatar_info;                                              // 0x02C0(0x0010) (ZeroConstructor)
	uint32_t                                           ai_provider;                                              // 0x02D0(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FDiffBaseModAIPlayerState : public FAIStateInfoBase
{
	...
	float                                              realscore_mu;                                             // 0x00C8(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              realscore_sigma;                                          // 0x00CC(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                zone_id;                                                  // 0x00D0(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               in_delivery_pool;                                         // 0x00D4(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x00D5(0x0003) MISSED OFFSET
	struct FDiffAIAttributeList                        Attributes;                                               // 0x00D8(0x0038)
	TArray<uint64_t>                                   pawn_state_list;                                          // 0x0110(0x0010) (ZeroConstructor)
	int                                                ai_kill_count;                                            // 0x0120(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                Gender;                                                   // 0x0124(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     OpenID;                                                   // 0x0128(0x0010) (ZeroConstructor)
	bool                                               has_gone;                                                 // 0x0138(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               in_afk;                                                   // 0x0139(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x2];                                       // 0x013A(0x0002) MISSED OFFSET
	int                                                emote_id;                                                 // 0x013C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                high_hp_destroy_bullet_num;                               // 0x0140(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                low_hp_destroy_bullet_num;                                // 0x0144(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                fatal_damage_destroy_bullet_num;                          // 0x0148(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FAIStateXYZ                                 head_position;                                            // 0x014C(0x000C)
	struct FAIStateXYZ                                 muzzle_position;                                          // 0x0158(0x000C)
	uint32_t                                           ally_master_id;                                           // 0x0164(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                first_lang_id;                                            // 0x0168(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                received_fatal_destroy_bullet_num;                        // 0x016C(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	struct FDiffBaseModAIPlayerState                   State;                                                    // 0x0020(0x0170)
	struct FAIPlayerInteractInfo                       player_interact_info;                                     // 0x0190(0x0058)
	struct FCameraState                                Camera;                                                   // 0x01E8(0x0040)
	struct FDiffAIPlayerWeapon                         Weapon;                                                   // 0x0228(0x0050)
	struct FDiffAIPlayerBackpack                       BackPack;                                                 // 0x0278(0x0050)
	struct FDiffAIPlayerEquipment                      equipment;                                                // 0x02C8(0x0050)
	uint32_t                                           Key;                                                      // 0x0318(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           ai_style;                                                 // 0x031C(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FChatMsgInfo>                        chatmsg_info_list;                                        // 0x0320(0x0010) (ZeroConstructor)
	TArray<struct FSignMsgInfo>                        signmsg_info_list;                                        // 0x0330(0x0010) (ZeroConstructor)
	TArray<struct FMapMarkInfo>                        mapmark_info_list;                                        // 0x0340(0x0010) (ZeroConstructor)
	TArray<struct FAIAvatarInfo>                       avatar_info;                                              // 0x0350(0x0010) (ZeroConstructor)
	uint32_t                                           ai_provider;                                              // 0x0360(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FBaseModAIGameState : public FAIStateInfoBase
{
	...
	int                                                mod_game_type;                                            // 0x0064(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FDoorState : public FUniqueStateInfo
{
	...
	struct FAIStateXYZ                                 Rotation;                                                 // 0x0034(0x000C)
	int                                                Type;                                                     // 0x0040(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0044(0x0004) MISSED OFFSET
};
