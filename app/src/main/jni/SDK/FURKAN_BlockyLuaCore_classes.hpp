...
public:
	...
	TEnumAsByte<EBlockyAccessType>                     CurSelectAccess;                                          // 0x0129(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsCustomVar;                                              // 0x012A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBlockListShowType>                    ShowType;                                                 // 0x012B(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
