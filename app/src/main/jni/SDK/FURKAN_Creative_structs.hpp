...
// Enum Creative.ECreativeUIEasingStyle
enum class ECreativeUIEasingStyle : uint8_t
{
	ECreativeUIEasingStyle__None   = 0,
	ECreativeUIEasingStyle__Linear = 1,
	ECreativeUIEasingStyle__Sine   = 2,
	ECreativeUIEasingStyle__Quad   = 3,
	ECreativeUIEasingStyle__Cubic  = 4,
	ECreativeUIEasingStyle__Quart  = 5,
	ECreativeUIEasingStyle__Quint  = 6,
	ECreativeUIEasingStyle__Exponential = 7,
	ECreativeUIEasingStyle__Circular = 8,
	ECreativeUIEasingStyle__Back   = 9,
	ECreativeUIEasingStyle__Bounce = 10,
	ECreativeUIEasingStyle__ECreativeUIEasingStyle_MAX = 11
};


// Enum Creative.ECreativeUIEasingDirection
enum class ECreativeUIEasingDirection : uint8_t
{
	ECreativeUIEasingDirection__In = 0,
	ECreativeUIEasingDirection__Out = 1,
	ECreativeUIEasingDirection__InOut = 2,
	ECreativeUIEasingDirection__ECreativeUIEasingDirection_MAX = 3
};
...
enum class EMountStatus : uint8_t
{
	...
	EMountStatus__MountFailed      = 3,
	EMountStatus__EMountStatus_MAX = 4
};
...
// ScriptStruct Creative.CreativeUITweenParams
// 0x0004
struct FCreativeUITweenParams
{
	ECreativeUIEasingStyle                             PositionEasingStyle;                                      // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	ECreativeUIEasingStyle                             OpacityEasingStyle;                                       // 0x0001(0x0001) (ZeroConstructor, IsPlainOldData)
	ECreativeUIEasingStyle                             RotationEasingStyle;                                      // 0x0002(0x0001) (ZeroConstructor, IsPlainOldData)
	ECreativeUIEasingStyle                             ScaleEasingStyle;                                         // 0x0003(0x0001) (ZeroConstructor, IsPlainOldData)
};

// ScriptStruct Creative.CreativeUITweenInfo
// 0x0018
struct FCreativeUITweenInfo
{
	float                                              Time;                                                     // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	ECreativeUIEasingStyle                             EasingStyle;                                              // 0x0004(0x0001) (ZeroConstructor, IsPlainOldData)
	ECreativeUIEasingDirection                         EasingDirection;                                          // 0x0005(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0006(0x0002) MISSED OFFSET
	int                                                RepeatCount;                                              // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               Reverses;                                                 // 0x000C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
	float                                              delayTime;                                                // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FCreativeUITweenParams                      Params;                                                   // 0x0014(0x0004)
};

// ScriptStruct Creative.CreativeUIAnimationGoal
// 0x0014
struct FCreativeUIAnimationGoal
{
	float                                              PositionX;                                                // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              PositionY;                                                // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              Opacity;                                                  // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              Rotation;                                                 // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              Scale;                                                    // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FCreativeInstanceNode
{
	...
	bool                                               bDisableCollision;                                        // 0x0074(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0xB];                                       // 0x0075(0x000B) MISSED OFFSET
};
...
// ScriptStruct Creative.DSLParserNode
// 0x0090
struct FDSLParserNode
{
	struct FString                                     Kind;                                                     // 0x0000(0x0010) (ZeroConstructor)
	struct FString                                     Name;                                                     // 0x0010(0x0010) (ZeroConstructor)
	struct FString                                     Value;                                                    // 0x0020(0x0010) (ZeroConstructor)
	TArray<int>                                        Children;                                                 // 0x0030(0x0010) (ZeroConstructor)
	TMap<struct FString, int>                          Properties;                                               // 0x0040(0x0050) (ZeroConstructor)
};
