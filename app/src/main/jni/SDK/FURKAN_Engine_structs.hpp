...
// Generate on Wed Jul  8 15:41:22 2026
...
// Enum Engine.ELODDropResult
enum class ELODDropResult : uint8_t
{
	ELODDropResult__Success        = 0,
	ELODDropResult__DisabledByCVar = 1,
	ELODDropResult__InvalidIndex   = 2,
	ELODDropResult__AlreadyInRequestedState = 3,
	ELODDropResult__ProtectedLOD   = 4,
	ELODDropResult__NoValidLODRemaining = 5,
	ELODDropResult__CPUDataUnavailable = 6,
	ELODDropResult__NotOnGameThread = 7,
	ELODDropResult__PendingStreamingLoad = 8,
	ELODDropResult__ELODDropResult_MAX = 9
};
...
// Enum Engine.EGlobalUROExcludeFlags
enum class EGlobalUROExcludeFlags : uint8_t
{
	EGlobalUROExcludeFlags__URO_Exclude_None = 0,
	EGlobalUROExcludeFlags__URO_Exclude_MinURO = 1,
	EGlobalUROExcludeFlags__URO_Exclude_Bias = 2,
	EGlobalUROExcludeFlags__URO_Exclude_All = 3,
	EGlobalUROExcludeFlags__URO_Exclude_MAX = 4
};
...
struct FObjectPool
{
	...
	TArray<class UObject*>                             Pool;                                                     // 0x0008(0x0010) (ZeroConstructor, Transient)
	TMap<class UObject*, uint32_t>                     RecycleTime;                                              // 0x0018(0x0050) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData00[0x50];                                      // 0x0068(0x0050) MISSED OFFSET
	int                                                Size;                                                     // 0x00B8(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bAutoDestroy;                                             // 0x00BC(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x00BD(0x0003) MISSED OFFSET
	int                                                ObjectLifePeriodTime;                                     // 0x00C0(0x0004) (ZeroConstructor, IsPlainOldData)
