...
public:
	...
	TArray<TEnumAsByte<ECollisionChannel>>             CustomBlockingChannels;                                   // 0x05A8(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
	...
	TEnumAsByte<EBuildingActorConstructingMode>        ConstructingMode;                                         // 0x0712(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
