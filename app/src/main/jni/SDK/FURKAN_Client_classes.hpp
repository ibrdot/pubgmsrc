...
// Generate on Wed Jul  8 15:41:24 2026
...
public:
	...
	struct FGameModeAIPlayerParams                     CachedAIPlayerParams;                                     // 0x00E8(0x0408)
	struct FString                                     LuaFilePath;                                              // 0x04F0(0x0010) (ZeroConstructor, Config)
	unsigned char                                      UnknownData02[0x50];                                      // 0x0500(0x0050) MISSED OFFSET
...
public:
	...
	struct FString                                     ZoneID;                                                   // 0x0060(0x0010) (ZeroConstructor)
	struct FString                                     goodsZoneID;                                              // 0x0070(0x0010) (ZeroConstructor)
	struct FString                                     offerID;                                                  // 0x0080(0x0010) (ZeroConstructor, Config)
	int                                                iAOSShop;                                                 // 0x0090(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0094(0x0004) MISSED OFFSET
	struct FString                                     offerID_H5;                                               // 0x0098(0x0010) (ZeroConstructor, Config)
	struct FString                                     offerID_WOW;                                              // 0x00A8(0x0010) (ZeroConstructor, Config)
	struct FString                                     offerID_WOWH5;                                            // 0x00B8(0x0010) (ZeroConstructor, Config)
	struct FString                                     payChannel_H5;                                            // 0x00C8(0x0010) (ZeroConstructor, Config)
	unsigned char                                      UnknownData02[0x58];                                      // 0x00D8(0x0058) MISSED OFFSET
	struct FString                                     IDCInfo;                                                  // 0x0130(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData03[0x18];                                      // 0x0140(0x0018) MISSED OFFSET
	struct FString                                     PAY_TYPE_UC;                                              // 0x0158(0x0010) (ZeroConstructor)
	struct FString                                     PAY_TYPE_GOODS;                                           // 0x0168(0x0010) (ZeroConstructor)
	struct FString                                     PAY_TYPE_SUBSCRIBE;                                       // 0x0178(0x0010) (ZeroConstructor)
	class UGameFrontendHUD*                            GameFrontendHUD;                                          // 0x0188(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x48];                                      // 0x0190(0x0048) MISSED OFFSET
	...
	void SetPayEnvironment(const struct FString& InPayEnvironment);
	void SetInIDC(const struct FString& InInIDC);
	void SetIDCInfo(const struct FString& InIDCInfo);
	void SetFrontendHUD(class UGameFrontendHUD* InFrontendHUD);
	void Reprovide();
	void Pay(const struct FString& productid, const struct FString& InPayItem, const struct FString& Country, const struct FString& currency, const struct FString& InChannelExtras, const struct FString& InAppExtends, const struct FString& InPayChannel, const struct FString& InURL, bool bUseWOW);
	...
	bool IsH5PayEnable();
	void Initialize(ECentauriMultiPayChannelSwitch envior, bool bUseWOW);
	void H5Pay(const struct FString& Country, const struct FString& InChannelExtras, const struct FString& InAppExtends, bool bUseWOW);
	void GoodsPresent(const struct FString& productid, const struct FString& InPayItem, const struct FString& Price, const struct FString& Country, const struct FString& currency, const struct FString& MetaData, const struct FString& InChannelExtras, const struct FString& InAppExtends, const struct FString& InPayChannel, const struct FString& InURL, bool bUseWOW);
	void Goods(const struct FString& productid, const struct FString& InPayItem, const struct FString& Price, const struct FString& Country, const struct FString& currency, const struct FString& InChannelExtras, const struct FString& InAppExtends, const struct FString& InPayChannel, const struct FString& InURL, bool bUseWOW);
	void GetProductInfo(TMap<struct FString, struct FString> listProductID, bool bUseWOW);
	struct FString getPF();
	struct FString GetPaymentProductId();
	struct FString GetPayChannel();
	struct FString GetPackChannel();
	struct FString GetOfferIDForWOWH5();
	struct FString GetOfferIDForWOW();
	struct FString GetOfferID();
	struct FString GetNativePackageTag();
	void GetMPInfo(const struct FString& Country, const struct FString& currency, const struct FString& InAppExtends, const struct FString& InDrmInfo, bool bUseWOW);
	void GetIntroPrice(TMap<struct FString, struct FString> listProductID, bool bUseWOW);
...
public:
	...
	struct FScriptMulticastDelegate                    OnLauncherEventCallback;                                  // 0x08C8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData22[0xC8];                                      // 0x08D8(0x00C8) MISSED OFFSET
	class UImageDownloader*                            ImageDownloaderInGame;                                    // 0x09A0(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                FpsForWindowClient;                                       // 0x09A8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData23[0x4];                                       // 0x09AC(0x0004) MISSED OFFSET
	class UUDPPingCollector*                           UDPPingCollector;                                         // 0x09B0(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               UIElemLayoutJsonConfigSwitch;                             // 0x09B8(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationAllSwitch;                                          // 0x09B9(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationBattleSwitch;                                       // 0x09BA(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationRankSwitch;                                         // 0x09BB(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               SelfieSwitch;                                             // 0x09BC(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               ReportBugSwitch;                                          // 0x09BD(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               FirstVoicePopupSwitch;                                    // 0x09BE(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               GDPRForbidVoiceSwitch;                                    // 0x09BF(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               GDPRSettingSwitch;                                        // 0x09C0(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData24[0x3];                                       // 0x09C1(0x0003) MISSED OFFSET
	int                                                GDPRUserType;                                             // 0x09C4(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bShouldShowAdaptTipInLobby;                               // 0x09C8(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData25[0x3];                                       // 0x09C9(0x0003) MISSED OFFSET
	float                                              fLaggingFPSDiffThreshold;                                 // 0x09CC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFPSDiffThresholdMin;                              // 0x09D0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFPSDiffThresholdMax;                              // 0x09D4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThreshold;                               // 0x09D8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThresholdMin;                            // 0x09DC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThresholdMax;                            // 0x09E0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fFPSReportInterval;                                       // 0x09E4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData26[0x10];                                      // 0x09E8(0x0010) MISSED OFFSET
	bool                                               bUnLoadNoGcPackage;                                       // 0x09F8(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData27[0x7];                                       // 0x09F9(0x0007) MISSED OFFSET
	TArray<class UPackage*>                            NoGcPackages;                                             // 0x0A00(0x0010) (ZeroConstructor)
	bool                                               bFlushAsyncLoadingBeforeGC;                               // 0x0A10(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableJMLog;                                             // 0x0A11(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData28[0xB6];                                      // 0x0A12(0x00B6) MISSED OFFSET
	bool                                               bEnableH5Cache;                                           // 0x0AC8(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bCheckWorldNameForLoadConfig;                             // 0x0AC9(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData29[0x6];                                       // 0x0ACA(0x0006) MISSED OFFSET
	class UColorBlindnessMgr*                          ColorBlindnessMgrInstace;                                 // 0x0AD0(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<struct FNativeHUDTickContainer>             NativeHUDTickList;                                        // 0x0AD8(0x0010) (ZeroConstructor)
	bool                                               IsNativeHUDTickLock;                                      // 0x0AE8(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               IsShutDown;                                               // 0x0AE9(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData30[0x2];                                       // 0x0AEA(0x0002) MISSED OFFSET
	int                                                NativeHUDTickIndex;                                       // 0x0AEC(0x0004) (ZeroConstructor, IsPlainOldData)
	class UAsyncLoadHelper*                            AsyncLoadHelper;                                          // 0x0AF0(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FString                                     BattleUtilsClassName;                                     // 0x0AF8(0x0010) (ZeroConstructor, Config)
	class UBattleUtils*                                BattleUtils;                                              // 0x0B08(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData31[0x8];                                       // 0x0B10(0x0008) MISSED OFFSET
	struct FScriptDelegate                             OnImagePickDetectEvent;                                   // 0x0B18(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnVideoPickEvent;                                         // 0x0B28(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnPermissionResultEvent;                                  // 0x0B38(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptMulticastDelegate                    OnDeviceRotationChangedEvent;                             // 0x0B48(0x0010) (ZeroConstructor, InstancedReference)
	struct FString                                     CurrentMapName;                                           // 0x0B58(0x0010) (ZeroConstructor)
...
public:
	...
	class UTexture2D* GetTexture2DFromArrayWithSRGB(TArray<unsigned char> OutArray, bool IsCompressed, bool bSRGB);
...
public:
	...
	static void UQMCrashReportStuck(int threadId, int maxChecks, int64_t CheckInterval, const struct FString& Name, const struct FString& Message, const struct FString& ExtraInfo, int dumpNativeType);
	static void UQMCrashPutUserData(const struct FString& Key, const struct FString& Value);
	static void UQMCrashPostExceptionWithCustomData(int Category, const struct FString& stack, TMap<struct FString, struct FString> customData, int dumpNativeType);
	static void UQMCrashPostExceptionFullWithCustomData(int Category, const struct FString& Name, const struct FString& Reason, const struct FString& stack, TMap<struct FString, struct FString> customData, int dumpNativeType);
	...
	static int TakeHighResScreenshot_LuaState();
	static bool TakeHighResScreenshot(const struct FString& Filename, int ResolutionX, int ResolutionY, float ResolutionScale);
	...
	static void SnapshotLobbyUObjects(const struct FString& Tag);
	...
	static void SetScreenPadding(const struct FMargin& InPadding);
	...
	static int SetDeviceQualityLevel_LuaState();
	static bool SetDeviceQualityLevel(int NewLevel);
	...
	static int PurgePackageByKeyword(const struct FString& Keyword);
	...
	static bool LoadSideLoadSOFromOBB();
	...
	static int GetThreadIndexByThreadIOS(int TargetThread);
	...
	static struct FMargin GetScreenPadding();
	...
	static struct FString GetCrashUserAction();
	...
	static void FeatureGuardSet(const struct FString& FeatureName, bool bEnable);
	...
	static void CreateWidgetInfoCollector_Reset();
	static void CreateWidgetInfoCollector_OnLevelStart();
	static void CreateWidgetInfoCollector_OnLevelEnd();
	...
	static int ActivateCameraByName_LuaState();
	static bool ActivateCameraByName(const struct FString& CameraName);
...
public:
	...
	TMap<unsigned char, struct FString>                ReportSettingConfig;                                      // 0x0128(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	unsigned char                                      UnknownData01[0x50];                                      // 0x0178(0x0050) MISSED OFFSET
	struct FString                                     CachedSaveGameName;                                       // 0x01C8(0x0010) (ZeroConstructor, Config)
	struct FScriptDelegate                             GetUserSettingsDelegate;                                  // 0x01D8(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	class UEffectSettingMgr*                           EffectSettingMgrInstace;                                  // 0x01E8(0x0008) (ZeroConstructor, IsPlainOldData)
	class USaveGame*                                   UserSettings;                                             // 0x01F0(0x0008) (ZeroConstructor, IsPlainOldData)
	class USaveGame*                                   UserSettingsShadowData;                                   // 0x01F8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x8];                                       // 0x0200(0x0008) MISSED OFFSET
	class UClass*                                      UserSettingsClass;                                        // 0x0208(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FString                                     UserSettingsClassName;                                    // 0x0210(0x0010) (ZeroConstructor, Config)
	struct FString                                     ActiveSaveGameName;                                       // 0x0220(0x0010) (ZeroConstructor, Config)
	unsigned char                                      UnknownData03[0x8];                                       // 0x0230(0x0008) MISSED OFFSET
	struct FString                                     LanguageSettingsClassName;                                // 0x0238(0x0010) (ZeroConstructor, Config)
	struct FString                                     LanguageSaveGameName;                                     // 0x0248(0x0010) (ZeroConstructor, Config)
	unsigned char                                      UnknownData04[0xB0];                                      // 0x0258(0x00B0) MISSED OFFSET
	TMap<struct FString, bool>                         LanguageMap;                                              // 0x0308(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData05[0x8];                                       // 0x0358(0x0008) MISSED OFFSET
	class UClass*                                      SaveGameUIElemLayoutClass;                                // 0x0360(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	static int IsVolumetricLightmapRegistered(class UObject* WorldContextObject, const struct FName& LevelPackageName);
	...
	static void EnsureVolumetricLightmapRegistered(class UObject* WorldContextObject, const struct FName& LevelPackageName);
...
public:
	...
	struct FLinearColor                                TextColor;                                                // 0x01B4(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	TEnumAsByte<ETextJustify>                          Justification;                                            // 0x01C4(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETextVerticalJustify>                  TextVerticalJustification;                                // 0x01C5(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               AutoWrapText;                                             // 0x01C6(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x1];                                       // 0x01C7(0x0001) MISSED OFFSET
	struct FScrollBarStyle                             ScrollBarStyle;                                           // 0x01C8(0x0680) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FMargin                                     HScrollBarPadding;                                        // 0x0848(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, IsPlainOldData)
	struct FMargin                                     VScrollBarPadding;                                        // 0x0858(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, IsPlainOldData)
	float                                              WrapTextAt;                                               // 0x0868(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FMargin                                     Margin;                                                   // 0x086C(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	float                                              LineHeightPercentage;                                     // 0x087C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FString                                     HyperlinkDecoratorTag;                                    // 0x0880(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FString                                     HyperlinkCallBackFunctionName;                            // 0x0890(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FString                                     HyperlinkCallBackTableName;                               // 0x08A0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	unsigned char                                      UnknownData05[0x270];                                     // 0x08B0(0x0270) MISSED OFFSET
	class UGameFrontendHUD*                            GameFrontendHUD;                                          // 0x0B20(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FScriptDelegate                             OnSpeechFileTranslateCallback;                            // 0x00D0(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnSpeechTranslateCallback;                                // 0x00E0(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnSpeechStreamTranslateCallback;                          // 0x00F0(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x10];                                      // 0x0100(0x0010) MISSED OFFSET
	struct FString                                     ServerInfo;                                               // 0x0110(0x0010) (ZeroConstructor, Config)
	uint32_t                                           openVoiceSDKLog;                                          // 0x0120(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           MicVolumeMUFactor;                                        // 0x0124(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           SpeekerVolumeMUFactor;                                    // 0x0128(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                RoomOperationTimeout;                                     // 0x012C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UGameFrontendHUD*                            GameFrontendHUD;                                          // 0x0130(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x70];                                      // 0x0138(0x0070) MISSED OFFSET
	struct FScriptDelegate                             OpenMicFail;                                              // 0x01A8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OpenMicSuccess;                                           // 0x01B8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             CloseMicFail;                                             // 0x01C8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             BeforeOperation;                                          // 0x01D8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             CloseMicSuccess;                                          // 0x01E8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OpenSpeakerFail;                                          // 0x01F8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OpenSpeakerSuccess;                                       // 0x0208(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             CloseSpeakerFail;                                         // 0x0218(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             CloseSpeakerSuccess;                                      // 0x0228(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             JoinRoomFail;                                             // 0x0238(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             JoinRoomNotify;                                           // 0x0248(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             QuitRoomNotify;                                           // 0x0258(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             JoinLbsRoomNotify;                                        // 0x0268(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             QuitLbsRoomNotify;                                        // 0x0278(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             JoinCommonRoomNotify;                                     // 0x0288(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             QuitCommonRoomNotify;                                     // 0x0298(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             RoomStatusUpdatedNotify;                                  // 0x02A8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             SetAppInfoSuccess;                                        // 0x02B8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             SetAppInfoFail;                                           // 0x02C8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             GetReconnectInfo;                                         // 0x02D8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             ImSpeakingNotify;                                         // 0x02E8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             TestMicFail;                                              // 0x02F8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             TestMicSuccess;                                           // 0x0308(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             QuitRoomFail;                                             // 0x0318(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             DownLoadFileNotify;                                       // 0x0328(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             UploadFileNotify;                                         // 0x0338(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnPlayRecordedFileNotify;                                 // 0x0348(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             KwsNotify;                                                // 0x0358(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             ApplyMessageKeyNotify;                                    // 0x0368(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             MemberIsSpeakingNotify;                                   // 0x0378(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             LbsMemberIsSpeakingNotify;                                // 0x0388(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnMuteSwitchResult;                                       // 0x0398(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnWakeUpNotify;                                           // 0x03A8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnMicOptMuteResultNotify;                                 // 0x03B8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             ReportVoiceTimeToServer;                                  // 0x03C8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             RecordSuccess;                                            // 0x03D8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             RecordFail;                                               // 0x03E8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             UploadSuccess;                                            // 0x03F8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             UploadFail;                                               // 0x0408(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             EnableRoomMicrophone;                                     // 0x0418(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             ExitInfectionGameMode;                                    // 0x0428(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             JoinInfectionGameMode;                                    // 0x0438(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             RequestPrivacyInSetting;                                  // 0x0448(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnReportPlayerCallback;                                   // 0x0458(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnVoiceSDKEvent;                                          // 0x0468(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             BeforeVoiceSDKInitDelegate;                               // 0x0478(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             AfterVoiceSDKInitDelegate;                                // 0x0488(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             AudioRouteChangedAfterSpeakerDelegate;                    // 0x0498(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             AudioSessionInterruptedDelegate;                          // 0x04A8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnRoomMemeberInfoDelegate;                                // 0x04B8(0x0010) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData04[0x88];                                      // 0x04C8(0x0088) MISSED OFFSET
	struct FScriptDelegate                             OnDeliverDataCallback;                                    // 0x0550(0x0010) (ZeroConstructor, InstancedReference)
	...
	int SpeechStreamTranslateStart(const struct FString& InFileID, const struct FString& InOutFilePath, int InSrcLang, int InTargetLang, const struct FString& InVoiceType, int InVolume, int InTimeoutMS);
	...
	int EnableCommonRoomSpeaker(const struct FString& InRoomName, bool InEnable);
	int EnableCommonRoomMic(const struct FString& InRoomName, bool InEnable);
