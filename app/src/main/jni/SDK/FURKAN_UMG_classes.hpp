...
public:
	...
	struct FScriptDelegate                             ShadowColorAndOpacityDelegate;                            // 0x0280(0x0010) (ZeroConstructor, InstancedReference)
	...
	unsigned char                                      UnknownData03[0x12];                                      // 0x0296(0x0012) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             ColorAndOpacityDelegate;                                  // 0x0218(0x0010) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             OnMouseButtonDownEvent;                                   // 0x0240(0x0010) (Edit, ZeroConstructor, InstancedReference)
	struct FSoftObjectPath                             AsyncLoadResourcePath;                                    // 0x0250(0x0018)
	unsigned char                                      UnknownData02[0x20];                                      // 0x0268(0x0020) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData01[0x2];                                       // 0x04CA(0x0002) MISSED OFFSET
	...
	TEnumAsByte<EVirtualKeyboardType>                  KeyboardType;                                             // 0x04D6(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData04[0x10];                                      // 0x0500(0x0010) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData03[0x10];                                      // 0x0468(0x0010) MISSED OFFSET
