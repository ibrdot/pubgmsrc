...
{
public:
	struct FScriptMulticastDelegate                    PlayerEventDelegate;                                      // 0x0298(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0x18];                                      // 0x02A8(0x0018) MISSED OFFSET
	class UPVideoPlayer*                               m_pPlayer;                                                // 0x02C0(0x0008) (ZeroConstructor, IsPlainOldData)
