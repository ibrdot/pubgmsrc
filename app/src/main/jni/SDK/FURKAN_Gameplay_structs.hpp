...
struct FGameModePlayerParams
{
	...
	float                                              RealScoreMu;                                              // 0x03EC(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              RealScoreSigma;                                           // 0x03F0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData17[0x4];                                       // 0x03F4(0x0004) MISSED OFFSET
};
...
{
	int8_t                                             AIType;                                                   // 0x03F4(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x03F5(0x0003) MISSED OFFSET
	uint32_t                                           AILevel;                                                  // 0x03F8(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bMLAIPlayer;                                              // 0x03FC(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bMLDelivery;                                              // 0x03FD(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x03FE(0x0002) MISSED OFFSET
	uint32_t                                           MLBotType;                                                // 0x0400(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bBornIslandAI;                                            // 0x0404(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bAITakeOver;                                              // 0x0405(0x0001) (ZeroConstructor, IsPlainOldData)
