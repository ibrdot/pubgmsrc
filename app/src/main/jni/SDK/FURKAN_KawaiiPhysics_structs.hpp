...
// Generate on Wed Jul  8 15:41:29 2026
...
// Enum KawaiiPhysics.EComplianceType
enum class EComplianceType : uint8_t
{
	EComplianceType__Leather       = 0,
	EComplianceType__Rubber        = 1,
	EComplianceType__Silk          = 2,
	EComplianceType__Custom        = 3,
	EComplianceType__EComplianceType_MAX = 4
};


// Enum KawaiiPhysics.ELateralConstraintMode
enum class ELateralConstraintMode : uint8_t
{
	ELateralConstraintMode__PBD    = 0,
	ELateralConstraintMode__XPBD   = 1,
	ELateralConstraintMode__ELateralConstraintMode_MAX = 2
};


// Enum KawaiiPhysics.EKawaiiPhysicsSimulationSpace
enum class EKawaiiPhysicsSimulationSpace : uint8_t
{
	EKawaiiPhysicsSimulationSpace__ComponentSpace = 0,
	EKawaiiPhysicsSimulationSpace__WorldSpace = 1,
	EKawaiiPhysicsSimulationSpace__EKawaiiPhysicsSimulationSpace_MAX = 2
};
...
// ScriptStruct KawaiiPhysics.KawaiiPhysicsEdgeCollisionSettings
// 0x0024
struct FKawaiiPhysicsEdgeCollisionSettings
{
	bool                                               bEnableEdgeCollision;                                     // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
	int                                                StripIndex;                                               // 0x0004(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                TotalStripCount;                                          // 0x0008(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              CollisionTolerance;                                       // 0x000C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDebugDrawInGame;                                         // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bActiveLateralConstraint;                                 // 0x0011(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0012(0x0002) MISSED OFFSET
	int                                                LateralConstraintIterationCount;                          // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LateralConstraintWeight;                                  // 0x0018(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseDiagonalEdgesForLateralConstraint;                    // 0x001C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	ELateralConstraintMode                             LateralConstraintMode;                                    // 0x001D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EComplianceType                                    ComplianceType;                                           // 0x001E(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1];                                       // 0x001F(0x0001) MISSED OFFSET
	float                                              ComplianceValueOverride;                                  // 0x0020(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};

// ScriptStruct KawaiiPhysics.NewKawaiiPhysicsModifyBone
// 0x0170
struct FNewKawaiiPhysicsModifyBone
{
	...
	struct FVector                                     ForwardPos;                                               // 0x00A4(0x000C) (IsPlainOldData)
	struct FVector                                     BackwardPos;                                              // 0x00B0(0x000C) (IsPlainOldData)
	bool                                               bIsEndBone;                                               // 0x00BC(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x00BD(0x0003) MISSED OFFSET
	struct FVector                                     WorldPoseLocation;                                        // 0x00C0(0x000C) (IsPlainOldData)
	unsigned char                                      UnknownData04[0xA4];                                      // 0x00CC(0x00A4) MISSED OFFSET
};

// ScriptStruct KawaiiPhysics.NewAnimNode_KawaiiPhysics
// 0x02C8 (0x0340 - 0x0078)
struct FNewAnimNode_KawaiiPhysics : public FAnimNode_SkeletalControlBase
{
	...
	EKawaiiPhysicsSimulationSpace                      SimulationSpace;                                          // 0x00B0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00B1(0x0003) MISSED OFFSET
	int                                                TargetFramerate;                                          // 0x00B4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               OverrideTargetFramerate;                                  // 0x00B8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x00B9(0x0003) MISSED OFFSET
	struct FKawaiiPhysicsSettings                      PhysicsSettings;                                          // 0x00BC(0x0018) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData02[0x4];                                       // 0x00D4(0x0004) MISSED OFFSET
	class UCurveFloat*                                 DampingCurve;                                             // 0x00D8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 WorldDampingLocationCurve;                                // 0x00E0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 WorldDampingRotationCurve;                                // 0x00E8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 StiffnessCurve;                                           // 0x00F0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 RadiusCurve;                                              // 0x00F8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 LimitAngleCurve;                                          // 0x0100(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUpdatePhysicsSettingsInGame;                             // 0x0108(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0109(0x0003) MISSED OFFSET
	float                                              DummyBoneLength;                                          // 0x010C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EPlanarConstraint                                  PlanarConstraint;                                         // 0x0110(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x7];                                       // 0x0111(0x0007) MISSED OFFSET
	TArray<struct FSphericalLimit>                     SphericalLimits;                                          // 0x0118(0x0010) (Edit, ZeroConstructor)
	TArray<struct FCapsuleLimit>                       CapsuleLimits;                                            // 0x0128(0x0010) (Edit, ZeroConstructor)
	TArray<struct FPlanarLimit>                        PlanarLimits;                                             // 0x0138(0x0010) (Edit, ZeroConstructor)
	float                                              TeleportDistanceThreshold;                                // 0x0148(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              TeleportRotationThreshold;                                // 0x014C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Gravity;                                                  // 0x0150(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector                                     MaxDistance;                                              // 0x015C(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector                                     MinDistance;                                              // 0x0168(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	bool                                               bEnableWind;                                              // 0x0174(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x0175(0x0003) MISSED OFFSET
	float                                              WindScale;                                                // 0x0178(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FKawaiiPhysicsEdgeCollisionSettings         EdgeCollisionSettings;                                    // 0x017C(0x0024) (Edit)
	bool                                               bEnableEndBoneControl;                                    // 0x01A0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x01A1(0x0003) MISSED OFFSET
	struct FVector                                     EndBoneControlOffset;                                     // 0x01A4(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FRotator                                    EndBoneControlRotation;                                   // 0x01B0(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector                                     RootBoneControlOffset;                                    // 0x01BC(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	TArray<struct FNewKawaiiPhysicsModifyBone>         ModifyBones;                                              // 0x01C8(0x0010) (ZeroConstructor)
	float                                              TotalBoneLength;                                          // 0x01D8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x4];                                       // 0x01DC(0x0004) MISSED OFFSET
	struct FTransform                                  PreSkelCompTransform;                                     // 0x01E0(0x0030) (IsPlainOldData)
	bool                                               bInitPhysicsSettings;                                     // 0x0210(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x12F];                                     // 0x0211(0x012F) MISSED OFFSET
};

// ScriptStruct KawaiiPhysics.SimulationSpaceCache
// 0x0060
struct FSimulationSpaceCache
{
	struct FTransform                                  ComponentToTargetSpace;                                   // 0x0000(0x0030) (IsPlainOldData)
	struct FTransform                                  TargetSpaceToComponent;                                   // 0x0030(0x0030) (IsPlainOldData)
};
